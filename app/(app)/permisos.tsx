...
const GRUPOS_PERMISOS: { titulo: string; codigos: string[] }[] = [
  {
    ...
    codigos: [
      ...
      'ajustes.sincronizaciones.ventas_producto',
    ],
  },
  {
  ...
  },
  {
    ...
    codigos: [
      ...
      'incentivos_producto.editar',
      'incentivos_producto.borrar',
...
const PERMISOS_LABELS: Record<string, string> = {
  ...
  'mantenimiento.facturar': 'Mantenimiento · Generar las facturas mensuales de reparaciones',
  ...
  'pedidos.crear_entre_locales': 'Pedidos · Enviar desde el almacén de otro local (genera factura entre sociedades)',
  ...
  'compras.facturar':
    'Compras · Generar las facturas mensuales de ventas internas y los abonos de rappel',
  'mia.ver': 'MIA · Ver config, sync, mapa, calendario, agrupaciones de familias e informes',
  'mia.configurar': 'MIA · Configurar productos, calendario y agrupaciones de familias',
  'mia.sincronizar': 'MIA · Sincronizar stocks desde Ágora',
  'mia.calcular': 'MIA · Calcular pedido recomendado (reservado)',
  'mia.aprobar': 'MIA · Aprobar y enviar a Ágora / PDF (reservado)',
  'escandallos.ver': 'Escandallos · Ver recetas de plato',
  'escandallos.editar': 'Escandallos · Crear, editar y borrar recetas',
  ...
  'ajustes.sincronizaciones.ventas_producto': 'Ajustes · Sync Ventas por producto',
  ...
  'rrhh.bonus.ver': 'RRHH · Bonus · Ver',
  'rrhh.bonus.editar': 'RRHH · Bonus · Editar % y cerrar mes',
  ...
  'rrpp.ver': 'RRPP · Ver módulo',
  'entradas.ver': 'Entradas · Ver tipos, listado y eventos',
  'entradas.crear': 'Entradas · Emitir entrada y sincronizar con Ágora',
  'entradas.enviar_whatsapp': 'Entradas · Generar enlace WhatsApp',
  'entradas.reintentar_agora': 'Entradas · Reintentar sincronización con Ágora',
  'entradas.configurar': 'Entradas · Config Ágora del local y tipos',
  'entradas.anular': 'Entradas · Anular entrada',
